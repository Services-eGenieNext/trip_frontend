...
export default function pricingCard({ data }: any) {
  return (
    <div className="relative mt-10 bg-[#F6FDFF] rounded-lg border-2 border-dashed border-[#AEDCF0] px-5 py-8">
      ...
      <div className={`absolute top-0 right-0 p-5 w-full h-full flex justify-end items-start ${CSS["overlay"]}`}>
