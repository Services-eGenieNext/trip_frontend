...
export default function FilterSidebar() {
  ...
  return (
    <>
      <span className="md:hidden fixed left-0 top-1/2 translate-y-[-50%] flex justify-centera items-center text-white w-[40px] h-[40px] bg-[#009ee2] rounded-r-lg z-10"
    ...
    <div className={`px-12 fixed inset-0 bg-white z-10 ${showFilter ? '-translate-x-[0%]' : '-translate-x-[100%]'} md:relative md:-translate-x-[0%] transition-all duration-300`}>
      <span
